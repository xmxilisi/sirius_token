...
import com.contract.modules.system.service.MonitorService;
import com.contract.utils.SCAdminConstant;
...
public class MonitorServiceImpl implements MonitorService {
    ...
    private Map<String,Object> getDiskInfo(OperatingSystem os) {
        ...
        for (OSFileStore fs : fsArray){
            ...
            if(osName.toLowerCase().startsWith(SCAdminConstant.WIN)) {
